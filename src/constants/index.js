...
export const musicText = [
  {
    content:
      "XOSC is my initiative to explore the vibrant landscapes of synthwave, drum & bass, jungle, ambient, and electronica. The project, originating from my first synthesizer purchase and early experiments with FL Studio, springs from a passion that grew steadily through years spent playing the piano and enjoying a rich tapestry of music.\nThe project has evolved, with two significant bodies of work marking its journey. The debut, 'Start Here EP', released on SoundCloud in late 2021, showcasing early themes and laying the groundwork for future explorations. It was swiftly followed by 'Analog Ascension' in 2022, a project bearing testimony to the creative liberty facilitated by the Reaper digital audio workstation — a transition that signaled a refined production approach and higher aesthetic value.\nIn the present moment, XOSC is a hive of burgeoning ideas. While other commitments temporarily steer my focus, the fervent spirit of creation remains, promising fresh, evolved soundscapes in forthcoming projects.",
  },
];
